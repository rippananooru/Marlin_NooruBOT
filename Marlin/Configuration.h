...
#define STRING_CONFIG_H_AUTHOR "@rippananooru" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Booting up NooruBOT" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "By: rippananooru"  // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "NooruBOT"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 13.64
    #define  DEFAULT_bedKi  0.68
    #define  DEFAULT_bedKd 68.72
...
#define X_MIN_POS -22.5
#define Y_MIN_POS -47.5
#define Z_MIN_POS 0
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,398.269957,105}  // default steps per unit for Ultimaker
